...
// Create two taxonomies, Genres (hierarchical like categories) and Writers (non-hierarchical like tags)
function create_book_taxonomies() {
    // Add Genre taxonomy (like categories)
    $labels = array(
    ...
    $args = array(
        'hierarchical'      => true, // True makes it like categories
        'labels'            => $labels,
        'show_ui'           => true,
    ...
    $args = array(
        'hierarchical'          => true, // Set to true to make it like categories with checkboxes
        'labels'                => $labels,
        'show_ui'               => true,
        'show_admin_column'     => true,
        'query_var'             => true,
